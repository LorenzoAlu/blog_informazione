...
class HomeController extends Controller
{
  ...
  public function index()
  {
    ...
    $articlesLenght=$articles->count();
    $ultimi=$articles->slice($articlesLenght-3)->reverse();
    $categories=Category::All();
    
     

    return view('home', compact('ultimi','categories'));
  }
  ...
  //   return view('articoli.mostratutti', compact('article'));
  // }
