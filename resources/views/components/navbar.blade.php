    <!-- navbar -->
    {{-- logo --}}
    <div class=" justify-content-center div_logo d-flex">
        <!--   Show this only lg screens and up   -->
        <a class="navbar-brand d-none d-lg-block  mx-auto img-fluid " href="{{ route('home') }}"><img
                class="logo_navbar " width="100px" alt="logo"></a>
    </div>
    <nav id="navbar" class="navbar navbar-expand-lg navbar-dark bg-dark m-0 p-0 fixed-top ">

        <!--  Show this only on mobile to medium screens  -->
        <a class="navbar-brand d-lg-none ms-2" href="{{ route('home') }}"><img class="logo_navbar_small"
                width="100px " alt="foto logo "></a>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        @foreach ($categories as $category)
                            <li><a class="dropdown-item"
                                    href="{{ route('categories.index', $category) }}">{{ $category->name }}</a></li>
                        @endforeach
                    </ul>
                </li>
                <li class="nav-item ps-1">
